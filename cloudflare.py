#!/usr/bin/env python
# This is to get pass Cloudflare Anti-bot protection. Requires Selenium and Safari, only built for Macs.
# It's not ideal - but it's simple and it means I can avoid Node.js which is a big pile of horse shit that
# I want to avoid totally. Made to be able to easily scrape web pages protected by cloudfare.
